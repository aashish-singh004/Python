...
In real life calculations, we use Bodmas but in python we use - PEMDAS
Parentheses, Exponents, Multiplication/Division, Addition/Subtraction and we calculate from left to right

Thats the basic mathematical operators, +, -, *, /, // and ** {** is exponent and // gives straight figure not rounded}
